import { Component, computed, Renderer2, ViewChild, inject } from '@angular/core';
...
import { LoaderSphere } from '@/shared/components/loader-sphere/loader-sphere';
...
@Component({
  ...
  template: `<div class="layout-wrapper" [ngClass]="containerClass()">
    ...
    @if (layoutService.showLoader()) {
      <div
        class="absolute inset-0 flex items-center justify-center backdrop-blur-sm bg-black/25 z-9999"
      >
        <app-loader-sphere />
      </div>
    }
